...
namespace FastestWaysInCSharp.FileProcessing.ParseCsv.Helpers;
...
public class FilePipeReader : PipeReader
{
    ...
    {
        _stream = new FileStream(filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite, bufferSize: bufferSize);
    ...
    public override async ValueTask<ReadResult> ReadAsync(CancellationToken cancellationToken = default)
    {
        ...
        var read = await _stream.ReadAsync(_buffer, _unconsumedBytes, _buffer.Length - _unconsumedBytes);
